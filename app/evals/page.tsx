...
export default function Home() {
  return (
    <div id="main" className="mx-auto flex w-full flex-col gap-15 sm:p-5">
      <div
        id="hero"
        className="mx-auto flex w-full max-w-5xl flex-col gap-8 bg-[url('/hero-evals.png')] bg-size-[auto_145px] bg-bottom-right bg-no-repeat sm:flex-row sm:bg-size-[auto_290px]"
      >
        <figure
          id="conversation.md"
          className="h-90 w-full max-w-xs overflow-hidden rounded-2xl border border-gray-200 bg-white p-2 shadow-xl"
        >
          ...
          <pre className="flex flex-col gap-4 p-4 text-xs text-wrap">
            <p>
              System: You are a helpful and concise virtual assistant for an
            ...
            <p>
              Assistant: Thanks! Your order is on the way and should arrive by
              tomorrow evening.
            </p>
          </pre>
        </figure>
        ...
        <div id="message" className="flex flex-col gap-4">
          ...
          <div className="max-w-lg text-5xl font-medium">
            Evalute <span className="underline decoration-dotted">Prompts</span>{" "}
      ...
      <div
        id="hebo-cloud"
        className="mx-auto flex w-full flex-row gap-2 rounded-xl border-2 border-solid border-gray-300 bg-stone-100 p-4 sm:max-w-5xl sm:bg-[url('/bg-hebo-cloud.png')] sm:bg-size-[auto_120px] sm:bg-right sm:bg-no-repeat"
      >
