---
title: "Hebo: Introduction"
description: "The fastest way to build and scale Ai agents"
---
...
- **Integrated Knowledge Base**: Seamlessly add and manage knowledge to enhance agent capabilities. [WIP]


## Getting Started

1. **Create an Account**: Visit [console.hebo.ai](https://console.hebo.ai) to create an account.
2. **Create an Agent**: The on-boarding flow will guide you through creating an agent a select a default model.
